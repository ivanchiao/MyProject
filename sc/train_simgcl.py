...
for epoch in range(num_epochs):
    ...
    for uij in loader:
        ...
        ssl_user_emb1, ssl_item_emb1 = model.simgcl_propagate(
            model.norm_adj,
            model.embeddings['user_embeddings'].weight,
            model.embeddings['item_embeddings'].weight)

        ssl_user_emb2, ssl_item_emb2 = model.simgcl_propagate(
            model.norm_adj,
            model.embeddings['user_embeddings'].weight,
            model.embeddings['item_embeddings'].weight)

        bpr_loss, reg_loss = model.calc_bpr_loss(main_user_emb, main_item_emb, u, i, j)
        ssl_loss = model.calc_ssl_loss(ssl_user_emb1, ssl_item_emb1, ssl_user_emb2, ssl_item_emb2, u, i)
